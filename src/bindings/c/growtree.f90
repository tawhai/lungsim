...
contains
  ...
  subroutine grow_tree_c(surface_elems_len, surface_elems, parent_ne_len, parent_ne, &
    ...
    integer,intent(in) :: parent_ne_len
    integer,intent(in) :: parent_ne(parent_ne_len)
