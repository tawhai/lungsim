...
!!!######################################################################
  ...
  subroutine update_mechs_surfactant_c(param_value) bind(C, name="update_mechs_surfactant_c")
    use parameter_types, only: update_mechs_surfactant
    implicit none
    
    logical, intent(in) :: param_value

    call update_mechs_surfactant(param_value)

  end subroutine update_mechs_surfactant_c
