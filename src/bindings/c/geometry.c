...
void scale_radius_sphere_c(int *ne_parent, double *radius, double *scale_factor);
...
void scale_radius_sphere(int ne_parent, double radius, double scale_factor)
{
  scale_radius_sphere_c(&ne_parent, &radius, &scale_factor);
}
