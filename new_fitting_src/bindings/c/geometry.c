...
extern double make_data_grid_c(int *elemlist_len, int elemlist[], double *offset, double *spacing, const char *filename, int *filename_len, const char *groupname, int *groupname_len, double *volume);
...
double make_data_grid(int elemlist_len, int elemlist[], double offset, double spacing, const char *filename, const char *groupname)
{
  double volume;
  int filename_len = (int)strlen(filename);
  int groupname_len = (int)strlen(groupname);
  make_data_grid_c(&elemlist_len, elemlist, &offset, &spacing, filename, &filename_len, groupname, &groupname_len, &volume);
  return volume;
}
