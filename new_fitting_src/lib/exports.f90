...
!
  ...
  subroutine export_data_field(EXDATAFILE, name, offset)
...
!!! local variables
    ...
    write(10,'('' 1) data_normal, field, rectangular cartesian, #Components=3'')')
    ...
    write(10,'('' 2) data_distance, field, rectangular cartesian, #Components=1'')')
    write(10,'(1X,''  1.  Value index= 4, #Derivatives=0'')')

    do nd = 1,num_data
       write(10,'(1X,''Node: '',I9)') nd + offset
       write(10,'(1X,4E13.5)')  (data_field(nj,nd), nj = 1,4)
    enddo !NOLIST
  ...
  end subroutine export_data_field
